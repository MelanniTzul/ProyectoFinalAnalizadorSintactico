...
public class NumeracionLinea extends JPanel
    ...
    public NumeracionLinea(JTextComponent component) {
        this(component, 3);
    }

    
    public NumeracionLinea(JTextComponent component, int minimumDisplayDigits) {
